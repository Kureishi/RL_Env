...
def test_version_flag(capsys):
    ...
    `autorefine 0.36.0` from the 33.1 single version source."""
    import contextlib
    import io
    buf = io.StringIO()
    ...
    assert buf.getvalue().strip() == "autorefine 0.36.0"
...
def test_version_round_v033():
    """A37 (SPEC.md 47.5, 33.1): the version stepped to `0.36.0` in
