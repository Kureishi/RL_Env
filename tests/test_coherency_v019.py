...
def test_version_single_source():
    ...
    # round label == package version (v0.23 ⇒ 0.23.0, M26 — the round
    # advanced per SPEC.md 33.1 with the v0.23 generalization batch, SPEC.md 37)
    assert autorefine.__version__ == "0.23.0"
