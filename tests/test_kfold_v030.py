...
key set; artifacts; app views); the version stepped to `0.39.0` in
...
def test_version_round_v030():
    """A34 (SPEC.md 44.3, 33.1): the version stepped to `0.39.0` in
    both sources (advanced again with v0.39 ⇒ `0.39.0`, M42, SPEC.md 53)."""
