...
key set; artifacts; app views); the version stepped to `0.30.0` in
both sources (33.1).
...
def test_version_round_v030():
    """A34 (SPEC.md 44.3, 33.1): the version stepped to `0.30.0` in
    both sources (v0.30 ⇒ `0.30.0`, M33, SPEC.md 44)."""
