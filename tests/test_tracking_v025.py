...
- Regression — A1–A28 stay green (no run behavior / summary key set /
  registry / artifact change); version stepped to `0.25.0` in both
  sources (33.1).
...
def test_version_round_v025():
    """A29 (SPEC.md 39.3, 33.1): the version stepped to `0.25.0` in both
    sources (v0.25 ⇒ `0.25.0`, both together)."""
